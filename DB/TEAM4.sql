...
DROP TABLE NOTIFICATION_MESSAGE CASCADE CONSTRAINT;
...
DROP SEQUENCE SEQ_NOTIFICATION_MESSAGE;
...
CREATE TABLE BLOCK_USERS( 
    ...
    UNBLOCK VARCHAR2(1) DEFAULT 'Y' NOT NULL CHECK(UNBLOCK IN ('Y', 'N'))  -- 차단 해제
);  
...
CREATE TABLE NOTIFICATION_MESSAGE (
    NOTIFICATION_MESSAGE_SEQ NUMBER PRIMARY KEY,
    USER_ID VARCHAR2(50),
    MESSAGE VARCHAR2(1000),
    SENT_TIME TIMESTAMP DEFAULT SYSDATE,
    IS_READ VARCHAR2(5) DEFAULT 'N' CHECK (IS_READ IN ('Y', 'N')),
    POST_SEQ NUMBER,
    CHATROOM_SEQ NUMBER
);
...
ALTER TABLE NOTIFICATION_MESSAGE ADD CONSTRAINT NOTIFICATION_MESSAGE_USER_ID_FK FOREIGN KEY(USER_ID) REFERENCES USER_INFO(USER_ID);
...
ALTER TABLE MATCHING_USER_INFO ADD CONSTRAINT MATCHING_USER_INFO_SEQ_FK FOREIGN KEY(POST_SEQ) REFERENCES POST(POST_SEQ);   -- 게시글 SEQ(게시글, 유저 매칭 정보)
ALTER TABLE NOTIFICATION_MESSAGE ADD CONSTRAINT NOTIFICATION_POST_SEQ_FK FOREIGN KEY(POST_SEQ) REFERENCES POST(POST_SEQ);   -- 게시글 SEQ(게시글, 알림)
...
ALTER TABLE NOTIFICATION_MESSAGE ADD CONSTRAINT NOTIFICATION_CHATROOM_FK FOREIGN KEY(CHATROOM_SEQ) REFERENCES CHATROOM (CHATROOM_SEQ);
...
CREATE SEQUENCE SEQ_NOTIFICATION_MESSAGE;
...
INSERT INTO PLACE VALUES(SEQ_PLACE.NEXTVAL, '강북구', 1);
